// pages/Orders.jsx (My Orders Page) - With Fixed Modals
...
const MyOrders = () => {
  ...
  const mockOrders = [
    ...
    { 
      ...
      amount: 'KSh 1,500',
      weight: '3kg',
      receiver: 'Sarah Wanjiku',
      receiverPhone: '+254 778 901 234',
      sender: 'John Mwangi',
      senderId: '3',
      createdAt: '2024-10-01T09:00:00Z',
      estimatedDelivery: '2024-10-03T18:00:00Z',
      trackingHistory: [
        { status: 'Order Created', timestamp: '2024-10-01T09:00:00Z', location: 'Nairobi CBD' }
      ]
    }
  ];
    ...
    <div className="p-4 md:p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <Link to="/customer/createorder">
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-lg text-sm font-medium transition-colors flex items-center gap-2 shadow-sm shadow-blue-200">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        ...
        <div className="bg-white p-3 rounded-lg border border-gray-200">
          ...
          <p className="text-lg font-bold text-blue-600">
            {orders.filter(o => o.status === 'In Transit' || o.status === 'Picked Up').length}
          </p>
        </div>
        <div className="bg-white p-3 rounded-lg border border-gray-200">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        <div className="flex gap-2">
          ...
          <button className="px-4 py-2.5 border border-gray-200 rounded-lg bg-white hover:bg-gray-50 transition-colors flex items-center gap-2 text-sm text-gray-600">
                        ...
                        {canModify ? (
                          ...
                          <button
                            ...
                            title={
                              ...
                              order.status === 'Cancelled' ? 'Order already cancelled' :
