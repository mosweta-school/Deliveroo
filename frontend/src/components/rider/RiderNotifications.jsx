// frontend/src/components/rider/RiderNotifications.jsx
import React, { useState, useEffect, useCallback } from 'react';
import { Bell, Truck, Package, User, AlertCircle } from 'lucide-react';
...
const RiderNotifications = () => {
  ...
  // Get relevant rider notification types
  const riderNotificationTypes = [
    { value: 'all', label: 'All', icon: Bell },
    { value: 'parcel', label: 'Parcels', icon: Package },
    { value: 'rider', label: 'Rider', icon: User },
